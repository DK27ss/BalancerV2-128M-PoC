...
contract BalancerArbitrumSwapsTest is Test {
    ...
    function testArbitrumExactSwaps() public {
        ...
        swaps[0] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: cbETH,
            amount: 381478578866960950133,
            expectedIn: 407409503509418236936,
            indexIn: 1,
            indexOut: 0
        });
        ...
        swaps[1] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: wstETH,
            amount: 36014566637470003060,
            expectedIn: 42643309507948554941,
            indexIn: 1,
            indexOut: 2
        });
        ...
        swaps[2] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: rETH,
            amount: 40888512865421358094,
            expectedIn: 44466732936930249407,
            indexIn: 1,
            indexOut: 3
        });
        ...
        swaps[3] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: cbETH,
            amount: 3814785788669609501,
            expectedIn: 4071892041540237390,
            indexIn: 1,
            indexOut: 0
        });
        ...
        swaps[4] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: wstETH,
            amount: 360145666374700031,
            expectedIn: 426202342600850576,
            indexIn: 1,
            indexOut: 2
        });
        ...
        swaps[5] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: rETH,
            amount: 408885128654213581,
            expectedIn: 444427045849747920,
            indexIn: 1,
            indexOut: 3
        });
        ...
        swaps[6] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: cbETH,
            amount: 38147857886696095,
            expectedIn: 40696903248956923,
            indexIn: 1,
            indexOut: 0
        });
        ...
        swaps[8] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: rETH,
            amount: 4088851286542136,
            expectedIn: 4442029212104502,
            indexIn: 1,
            indexOut: 3
        });
        ...
        swaps[9] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: cbETH,
            amount: 381478578866961,
            expectedIn: 406749862066954,
            indexIn: 1,
            indexOut: 0
        });
        ...
        swaps[10] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: wstETH,
            amount: 36014566637470,
            expectedIn: 42442033239736,
            indexIn: 1,
            indexOut: 2
        });
        ...
        swaps[11] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: rETH,
            amount: 40888512865422,
            expectedIn: 44524298703173,
            indexIn: 1,
            indexOut: 3
        });
        ...
        swaps[12] = ExactSwapData({
            tokenIn: POOL_BPT,
            tokenOut: cbETH,
            amount: 3814785788670,
            expectedIn: 4066562685395,
            indexIn: 1,
            indexOut: 0
        });
        ...
        swaps[111] = ExactSwapData({
            ...
            expectedIn: 9862871696198828244,
            indexIn: 3,
            indexOut: 1
        });
        
        swaps[112] = ExactSwapData({
            tokenIn: cbETH,
            tokenOut: POOL_BPT,
            amount: 163494843838840439485,
            expectedIn: 4455279606583867,
            indexIn: 0,
            indexOut: 1
        });
        
        swaps[113] = ExactSwapData({
            tokenIn: wstETH,
            tokenOut: POOL_BPT,
            amount: 163494843838840439485,
            expectedIn: 19657862359507516,
            indexIn: 2,
            indexOut: 1
        });
        
        swaps[114] = ExactSwapData({
            tokenIn: rETH,
            tokenOut: POOL_BPT,
            amount: 163494843838840439485,
            expectedIn: 9665492270625015158,
            indexIn: 3,
            indexOut: 1
        });
        
        swaps[115] = ExactSwapData({
            tokenIn: cbETH,
            tokenOut: rETH,
            amount: 18000000000000000000,
            expectedIn: 5992912983529816883,
            indexIn: 0,
            indexOut: 3
        });
        ...
        console.log("Internal cbETH:", internalBalances[0]);
        console.log("Internal BPT:", internalBalances[1]);
        console.log("Internal wstETH:", internalBalances[2]);
        console.log("Internal rETH:", internalBalances[3]);
        ...
        if (internalBalances[0] > 0 || internalBalances[1] > 0 || internalBalances[2] > 0 || internalBalances[3] > 0) {
            ...
            console.log("Internal balances withdrawn successfully");
        } else {
